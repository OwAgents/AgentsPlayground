...
- Do not return `localhost:<port>` when that service can be opened through the worker's public URL. Convert it to `https://{{WORKER_CHILD_HOST_PREFIX}}-<port>.agentsweb.space`.
