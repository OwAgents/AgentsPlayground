...
const icons: Record<string, string> = { codex: '/icons/codex.png', opencode: '/icons/opencode.png', hermes: '/icons/hermes.png', 'agent-zero': '/icons/agent-zero.png', openclaw: '/icons/openclaw.png', 'deepseek-harness': '/icons/deepseek.svg' }
